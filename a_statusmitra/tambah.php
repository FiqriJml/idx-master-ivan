                            ...
                            <form action="tambah_proses.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <label class="col-sm-2 control-label">Mitra</label>
                                        <div class="col-sm-10">
                                            <select class="form-control" name="mitra">
                                                <option>Pilih</option>
                                                <?php
                                                  $query = "SELECT * FROM mitra order by id_mitra desc";
                                                  $result = mysqli_query($con, $query);
                                                          
                                                  while($data = mysqli_fetch_assoc($result))
                                                  {
                                                  ?>
                                                  <option value="<?php echo $data['mitra']; ?>"><?php echo $data['mitra']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        ...
                                        <input type="hidden" name="id_statusmitra" value="<?php echo $cek['id_statusmitra'] ?>">
                                    </div>
                                </div>
                            </form>
                        </div>
