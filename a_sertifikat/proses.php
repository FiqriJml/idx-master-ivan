...
if (in_array($file_ext,$allowed_file_types) && ($filesize < 200000000))
{
	...
	if (file_exists("../img/sertifikat/" . $newfilename))
	{
		// Jika file sudah ada
	...
	{
		move_uploaded_file($_FILES["file"]["tmp_name"], "../img/sertifikat/" . $newfilename);
    ...
    // query
    $query = "INSERT INTO `sertifikat` (`id_sertifikat`,`nama`,`file`) VALUES (NULL, '$nama','$file');";
